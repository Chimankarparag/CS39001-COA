...
module tb_processor_six_stage;
    ...
    function [71:0] state_name;
        ...
        begin
            case (s)
                ...
                3'b100: state_name = "MEM_CHECK";
                3'b101: state_name = "WRITE_OUT";
                3'b110: state_name = "HALT";
    ...
    initial begin
        $display("\n===========================================================");
        $display("            NEW HALT MODULE TESTBENCH START (6-STAGE)      ");
        $display("===========================================================");
